...
const getAssignedToFromExamDefinition =
  "SELECT assignedto FROM exams_definition WHERE id = $1";
...
const submitExam =
  "UPDATE exams_instance SET starttime = $1, endtime = $2, takenby = $3, status = $4, questions = $5, grade = $7, passed = $8 WHERE id = $6;";
